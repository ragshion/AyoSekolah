...
public class LivesearchAkunAcvitiy extends AppCompatActivity {
    ...
    public void fetchContact(String type, String key){
        ...
        Call<List<Dataz>> call = api.getLivesearchAkun(type, key, sharedPrefManager.getSpUser());
        call.enqueue(new Callback<List<Dataz>>() {
            @Override
            public void onResponse(Call<List<Dataz>> call, Response<List<Dataz>> response) {
                loading.setVisibility(View.GONE);
                contacts = response.body();
                adapter = new LivesearchAdapter(contacts, LivesearchAkunAcvitiy.this);
            ...
            public void onFailure(Call<List<Dataz>> call, Throwable t) {
                loading.setVisibility(View.GONE);
                Toast.makeText(LivesearchAkunAcvitiy.this, "Error\n"+t.toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                View view = LivesearchAkunAcvitiy.this.getCurrentFocus();
//                InputMethodManager imm = (InputMethodManager)getSystemService(LivesearchAkunAcvitiy.this.INPUT_METHOD_SERVICE);
