...
public class DatazKecamatanActivity extends AppCompatActivity {
    ...
    private MaterialEditText kecamatan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_data_kecamatan);
        context = this;
        ...
        ic_livesearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent livesearch = new Intent(DatazKecamatanActivity.this, LivesearchAcvitiy.class);
...
//                spinnerDialog=new SpinnerDialog(DatazKecamatanActivity.this,array_kecamatan,"Select or Search City","Close Button Text");// With No Animation
                spinnerDialog=new SpinnerDialog(DatazKecamatanActivity.this,array_kecamatan,"Kecamatan",R.style.DialogAnimations_SmileWindow,"Tutup");// With 	Animation
...
//                Toast.makeText(context, response.body().toString(), Toast.LENGTH_SHORT).show();
    ...
    void countdata(){
        Service serviceApi = Client.getClient();
        Call<ResponseBody> count = serviceApi.count_by("KECAMATAN", kecamatan.getText().toString());
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if(response.isSuccessful()){
                    try{
                        ...
                        String total = kecamatan.getText()+" : ";
    ...
    private void load(int index){
        Call<List<Dataz>> call = api.getDataLokasi("data_ats",kategori,kecamatan.getText().toString(),data_kategori,index);
    ...
    private void loadMore(int index){
        ...
        Call<List<Dataz>> call = api.getDataLokasi("data_apd",kategori,kecamatan.getText().toString(),data_kategori,index);
        call.enqueue(new Callback<List<Dataz>>() {
            @Override
            public void onResponse(Call<List<Dataz>> call, Response<List<Dataz>> response) {
                if(response.isSuccessful()){
