...
public class DatazActivity extends AppCompatActivity {
...
//    Double latitude,longitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic_livesearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent livesearch = new Intent(DatazActivity.this, LivesearchAcvitiy.class);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if(response.isSuccessful()){
                    try{
                        ...
                        String total;
                        if (data_kategori.equalsIgnoreCase("all")){
                            total = "Total Data : ";
                        }else{
                            total = data_kategori+" : ";
                        }
    ...
    private void loadMore(int index){
        ...
        Call<List<Dataz>> call = api.getData("data_apd",kategori,data_kategori,index);
        call.enqueue(new Callback<List<Dataz>>() {
            @Override
            public void onResponse(Call<List<Dataz>> call, Response<List<Dataz>> response) {
                if(response.isSuccessful()){
