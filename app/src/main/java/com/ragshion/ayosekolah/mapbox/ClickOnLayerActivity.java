  ...
  public boolean onMapClick(@NonNull LatLng point) {
    ...
    if (featureList.size() > 0) {
      for (Feature feature : featureList) {
        ...
        Toast.makeText(ClickOnLayerActivity.this, "Wow berhasil di click",
...
//        + "d58f20f4a1d8841e8/regions.geojson")));
      ...
      loadedMapStyle.addSource(new GeoJsonSource(geoJsonLayerId, new URL("http://192.168.1.209/bts/maps/geojson")));
